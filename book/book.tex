...
\title{التفكير الاحصائي Think Stats}
\author{الآن ب. داوني Allen B. Downey}

\newcommand{\thetitle}{التفكير الاحصائي}
\newcommand{\thesubtitle}{التحليل الاستكشافي للبيانات في بيثون}
...
حقوق الطبع \copyright ~2014 Allen B. Downey.
...
يُسمح بنسخ و / أو توزيع و / أو تعديل هذا المستند بموجب شروط Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International License المتاحة على
\url{http://creativecommons.org/licenses/by-nc-sa/4.0/}.


مصدر \ LaTeX \ لهذا الكتاب متاح من
...
هذا الكتاب هو مقدمة للأدوات العملية للتحليل الاستكشافي للبيانات.
يتبع تنظيم الكتاب العملية التي أستخدمها عندما أبدأ العمل مع مجموعة بيانات:

\begin{itemize}

\item الاستيراد والتنظيف: مهما كان تنسيق البيانات ، عادة ما يستغرق الأمر بعض الوقت والجهد لقراءة البيانات وتنظيفها وتحويلها ، والتحقق من أن كل شيء كان سليما اثناء عملية الترجمة.
\index{cleaning}

\item استكشافات المتغير الفردي: عادةً ما أبدأ بفحص متغير واحد في كل مرة ، ومعرفة ما تعنيه المتغيرات ، والنظر في توزيعات القيم ، واختيار الإحصائيات الموجزة المناسبة.
\index{distribution}
